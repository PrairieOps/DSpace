...
public class UnAuthenticateAction extends AbstractAction
{
            ...
            String source, Parameters parameters) throws Exception
    {
        ...
        if (loginType != null && loginType.equals("CAS")) {
            ...
            location.append(ConfigurationManager.getProperty("cas.logout.url")).append("?url=").append(httpRequest.getScheme()).append("://").append(httpRequest.getServerName()).append(":").append(
